...
from order.models import ShopCart, Order, OrderProduct, CouponCode
...
class OrderProductCouponAdmin(admin.ModelAdmin):
...
admin.site.register(CouponCode,OrderProductCouponAdmin)